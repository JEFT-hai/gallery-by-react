  ...
  */
  rearrange(centerIndex){
    let imgsArrangeArr = this.state.imgsArrangeArr,
        ...
        //取出要布局上侧的图片状态信息
        topImgsSpliceIndex = Math.floor(Math.random()*(imgsArrangeArr.length - topImgNum));
        imgsArrangeTopArr = imgsArrangeArr.splice(topImgsSpliceIndex, topImgNum);
        ...
        if (imgsArrangeTopArr && imgsArrangeTopArr[0]) {
          imgsArrangeArr.splice(topImgsSpliceIndex, 0, imgsArrangeTopArr[0]);
        }
